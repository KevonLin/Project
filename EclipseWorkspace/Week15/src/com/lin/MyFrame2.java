...
public class MyFrame2 {
	...
	public void test1() {
		...
		// boxType.addItem(rsBook.getbType());
	}
	...
	private void initialize() {
		...
		pDel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "delete from Publishing where pNum = ?";
				new SqlOperation().Update(sql, pNum.getText());
				log.setText("Delete sucessful!");
			}
		});
		...
		// String sql = "select bType from Book where bType = ?";
		// MyBook rsBook = new SqlOperation().QueryForAll(sql, bNum.getText());
		// boxType.addItem(rsBook.getbType());
		...
		rDel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				new SqlOperation().Update(sql, bNum.getText());
				log.setText("Delete sucessful!");
			}
		});
		...
		gl_result.setHorizontalGroup(gl_result.createParallelGroup(Alignment.LEADING).addGroup(gl_result
				...
				.addGroup(gl_result.createParallelGroup(Alignment.LEADING, false).addGroup(gl_result
						.createSequentialGroup().addComponent(textBookType).addGap(28)
						.addComponent(bookType, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE).addGap(58)
						.addComponent(boxType, GroupLayout.PREFERRED_SIZE, 133, GroupLayout.PREFERRED_SIZE).addGap(104)
						.addComponent(rInsert, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE).addGap(33)
						.addComponent(rQuery, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE).addGap(31)
						.addComponent(rUpdate, GroupLayout.PREFERRED_SIZE, 67, GroupLayout.PREFERRED_SIZE).addGap(27)
		...
		gl_result.setVerticalGroup(gl_result.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_result.createSequentialGroup().addContainerGap(11, Short.MAX_VALUE)
						.addGroup(gl_result.createParallelGroup(Alignment.BASELINE)
								.addComponent(bookType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(boxType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(textBookType).addComponent(rInsert).addComponent(rQuery)
								.addComponent(rUpdate).addComponent(rDel))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 156, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(log, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
