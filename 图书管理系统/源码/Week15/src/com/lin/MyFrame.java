...
//				}
		...
		gl_result.setHorizontalGroup(
			gl_result.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_result.createSequentialGroup()
					.addGap(29)
					.addGroup(gl_result.createParallelGroup(Alignment.LEADING, false)
						.addGroup(gl_result.createSequentialGroup()
							.addGap(177)
							.addComponent(rInsert, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE)
							.addGap(91)
							.addComponent(rQuery, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE)
							.addGap(77)
							.addComponent(rUpdate, GroupLayout.PREFERRED_SIZE, 67, GroupLayout.PREFERRED_SIZE)
							.addGap(81)
		...
		gl_result.setVerticalGroup(
			gl_result.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_result.createSequentialGroup()
